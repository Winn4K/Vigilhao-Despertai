...
import './index.scss'
import NatalCards from '../NatalCards/NatalCards'

const NatalSolidario = () => {
  return (
    <div id='bg-natal-solidario'>
        <div id='content-natal-solidario'>
            <div>
                <img src="/assets/svg/NatalSolidario/titulo.svg" id='titulo' alt="" />
                <div>
